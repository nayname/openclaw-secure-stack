...
class PlanGenerator:
    ...
    def __init__(
        ...
        Args:
            ...
            schema_path: Path to the execution-plan JSON schema file.
                Defaults to schemas/execution-plan/1.0.0/schema.json
                resolved from the project root (derived from patterns_path).
        """
